...
class TestJsonObjectIdentity:
    ...
    def test_account_id_from_account_uuid_key(self):
        assert extract_account_id(LITELLM_USER_JSON) == "00000000-0000-0000-0000-0000000000a1"
    ...
    def test_real_span_shape_wrapper(self):
        ...
        assert extract_account_id_from_span(span) == "00000000-0000-0000-0000-0000000000a1"
